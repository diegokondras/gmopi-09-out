...
from .models import Post, CategoriaProduto
from django.shortcuts import render, get_object_or_404
from django.contrib.auth.decorators import login_required
from .forms import PostForm, CommentForm, CategoriaProdutoForm, ProdutoForm, EstoqueForm
from .models import Post, Comment, Produto, Estoque
